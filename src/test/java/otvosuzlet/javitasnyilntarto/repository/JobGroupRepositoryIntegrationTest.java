...
@SpringBootTest
class JobGroupRepositoryIntegrationTest {
    ...
    @Test
    @Transactional
    void testFindPersonIdByJobGroupId() {
        ...
        Integer foundPersonId = jobGroupRepository.findPersonIdByJobGroupId(savedPerson.getJobGroups().iterator().next().getId());
